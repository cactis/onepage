SwitchUser.setup do |config|
  ...
  # config.controller_guard = lambda { |current_user, request| current_user.id == 1 || Rails.env.development?}
  ...
  # config.view_guard = lambda { |current_user, request| current_user.id == 1 || Rails.env.development?}
